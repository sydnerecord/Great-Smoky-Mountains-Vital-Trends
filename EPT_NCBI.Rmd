...
---
Macroinvertebrates in GRSM - EPT & NCBI
Insect orders Ephemeroptera (mayflies), Plecoptera (stoneflies) and Trichoptera (caddisflies) are indicators of higher stream quality. 
Total EPT richness (number of taxa) or abundance weighted indices like NCBI can be used to evaulate stream quality
