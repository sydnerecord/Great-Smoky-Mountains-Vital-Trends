---
title: "GRSM_Macroinverts_EPT_NCBI"
author: "John Grady"
date: "2025-10-14"
...
```
```{r}
# If your NCBI sheet uses a different column than `Species`, change here:
...
ncbi_site_year <- inv_join %>%
  ...
  dplyr::summarize(
    NCBI = {
      num <- sum(genus_ncbi * Count, na.rm = TRUE)   # scored taxa contribute
      den <- sum(Count, na.rm = TRUE)                # total individuals (scored + unscored)
