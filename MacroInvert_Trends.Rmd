...
output:
  pdf_document:
    latex_engine: xelatex   # or lualatex; see below
geometry: margin=1in
---
...
# ---------------- Table checks ---------------------------------------
# ----------------------------------------------------------------------
#When sampled at at given location
...
p_richness <- ggplot(
  ...
  labs(x = "Year", y = "Genus Richness per Stream", color = "Stream") +
  theme_plot() +
  ggtitle("Genera Richness with linear fit") +
  scale_color_viridis_d(option = "turbo") +
  theme(
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
...
p_abundance <- ggplot(
  ...
  theme_plot() +
  ggtitle("Stream Abundance with linear fit") +
  scale_color_viridis_d(option = "turbo") +
  theme( panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
         panel.border = element_rect(color = "black", fill = NA, linewidth = 0.5),
         legend.position = "right") +
...
p_rel_ept <- ggplot(
  ...
  geom_point(size = 2) +
  stat_smooth(method = "lm", linetype = "dashed", se = F, show.legend = F, size = 0.5) +
  scale_y_continuous("Proportion EPT Abundance") +
  scale_x_continuous(
    breaks = seq(1985, 2025, by = 5),
    limits = c(1984, 2025)) +
  labs(x = "Year", y = "Abundance per Stream", color = "Stream") +
...
Month by month comparison over the summer
